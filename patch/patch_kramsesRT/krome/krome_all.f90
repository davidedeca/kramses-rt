...
!    num2col = 0.5d0 * ncalc * get_jeans_length(n(:),Tgas)
  ...
  function H2_dustJura(n,Tgas)
    ...
    H2_dustJura = n(idx_H)*ntot*3.d-18 * Tgas**0.5 * dust2gas_ratio*clump_factor
...
contains
  ...
  function get_cooling_array(n, Tgas)
    ...
    cools(idx_cool_ZCIE) = cooling_Z_CIE(n(:), Tgas)
...
!    if (.true.) then
!      print*, "POSSIBLE ERROR", photobinj(6), photobinrates(6)
!    endif
