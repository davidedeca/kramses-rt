module pm_parameters
  ...
  real(dp)::leaf_cell_vol_cpu=0
  real(dp)::leaf_cell_vol=0
  real(dp)::leaf_cell_tot_cpu=0
  real(dp)::leaf_cell_tot=450.87482770656817    !1e5 Msun !! initial GMC mass
  real(dp)::leaf_cell_cut_cpu=0
  real(dp)::leaf_cell_cut=0
  integer::star_line=1
