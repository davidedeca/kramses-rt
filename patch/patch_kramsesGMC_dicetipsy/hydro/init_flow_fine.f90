...
subroutine init_flow_fine(ilevel)
  ...
  real(kind=8),dimension(1:krome_nmols)::krome_init_var,krome_check_init,krome_mass
...
if(filetype.eq.'ascii')then
    ...
    ! krome equilibrium to each cell
    !if .not. first_call_init_flow: 
    !    call krome_equilibrium_cell(ilevel)  
...
subroutine init_gas_cic(ind_grid,ind_part,ind_grid_part,x0,ng,np,ilevel)
  use amr_commons
  use pm_commons
  use hydro_commons
  use dice_commons
...
subroutine krome_equilibrium_cell(ilevel)
  ...
  integer::ilevel,ngrid,igrid,ncache
  integer,dimension(1:nvector)::ind_grid
 ...
 do igrid=1,ncache,nvector
    ...
    do ind=1,twotondim
      ...
      do i=1,nleaf
         call krome_equilibrium(xion(:,i), T2(i))
      end do   
...
end subroutine krome_equilibrium_cell
