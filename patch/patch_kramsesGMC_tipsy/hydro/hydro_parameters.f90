module hydro_parameters
  ...
  real(dp)::smallc=1.d-30
  real(dp)::smallr=1.d-30
  ...
  ! Forcing parameters
  real(dp)::ampl_turb = 0.1
  logical::do_force = .false.
  logical::do_helmh = .true.
  real(dp)::a_helmh=1.
  real(dp)::k1_force=1.
  real(dp)::k2_force=1.5
  real(dp)::pk_force=7./6.
  real(dp)::t_turn = 0.1
  real(dp)::t_turb = 0.
  integer::iseed_force = 123456789
