module pm_commons
  ...
  real(dp),allocatable,dimension(:,:)::star_list
  ...
  real(dp),allocatable,dimension(:)  ::uthp       ! Masses
  real(dp),allocatable,dimension(:)  ::ep       ! Masses
  real(dp),allocatable,dimension(:)  ::hp       ! Masses
  real(dp),allocatable,dimension(:)  ::yp       ! Masses
