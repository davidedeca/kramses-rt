subroutine read_hydro_params(nml_ok)
  ...
  namelist/init_params/filetype,file_x_offset, file_y_offset, file_z_offset,file_ncell, initfile,carving_restart,carving_radius,multiple,nregion,region_type &
  ...
  namelist/refine_params/x_refine,y_refine,z_refine,r_refine &
       ...
       & ,m_refine,err_grad_d,err_grad_p,err_grad_u,H2_d, star_refine &
       & ,threshold_d,floor_d,floor_u,floor_p,ivar_refine,var_cut_refine &
#ifdef SOLVERmhd
  ...
  namelist/cooling_params/cooling,metal,isothermal,haardt_madau,J21 &
       ...
       & ,krome_chem, CR_ionisation_rate, H2_dissociation_rate
  ...
  namelist/sf_params/m_star,t_star,n_star,T2_star,g_star,del_star &
       ...
       & ,t_starformation,max_star_number,eta_star,m_star_average
  ...
  ! Forcing parameters
  namelist /force/ do_force, do_helmh, a_helmh, k1_force, k2_force, ampl_turb, t_turn, t_turb, pk_force, iseed_force
  ...
  ! initialize default var_region before reading from namelist
#if defined(krome_on)
  var_region(1:MAXREGION,KROME_idx_H   ) = 0.752471d+00 !H
  var_region(1:MAXREGION,KROME_idx_E   ) = 0.608748d-07 !E
  var_region(1:MAXREGION,KROME_idx_Hj  ) = 0.111772d-03 !H+
  var_region(1:MAXREGION,KROME_idx_HE  ) = 0.247527d+00 !HE
  var_region(1:MAXREGION,KROME_idx_HEj ) = 0.287201d-26 !HE+
  var_region(1:MAXREGION,KROME_idx_HEjj) = 0.334857d-52 !HE++
  var_region(1:MAXREGION,KROME_idx_Hk  ) = 0.626462d-11 !H-
  var_region(1:MAXREGION,KROME_idx_H2  ) = 0.559307d-06 !H2
  var_region(1:MAXREGION,KROME_idx_H2j ) = 0.728777d-13 !H2+
#endif
...
! MHD sets enums for riemann solvers, hydro just does a string compare
  ...
  krome_off       = ndim+2
  if(metal) then
    krome_off = krome_off+1
  endif
  if(nener.gt.0) then
    krome_off = krome_off+nener
  endif
  ...
  if(myid==1) then
    write(*,*)' '
    write(*,*)'passive varible id'
    write(*,*)'metal ',imetal
    write(*,*)'refine',ivar_refine
    write(*,*)'delay ',idelay
    write(*,*)'chem  ',ichem
#if defined(krome_on)
    write(*,*)'krome:'
    ...
    write(*,*)'  E   ',krome_off+2
    write(*,*)'  H+  ',krome_off+3
    write(*,*)'  He  ',krome_off+4
    write(*,*)'  He+ ',krome_off+5
    write(*,*)'  He++',krome_off+6
    write(*,*)'  H-  ',krome_off+7
    write(*,*)'  H2  ',krome_off+8
    write(*,*)'  H2+ ',krome_off+9
#endif
    write(*,*)' '
  endif
